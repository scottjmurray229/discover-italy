 ...
 *   Reads/writes via GitHub API so Adrin can edit from the Italy.
 *   Saves create commits directly in the repo.
 *
 * Env vars:
 *   GITHUB_TOKEN    — GitHub personal access token (enables remote mode)
 *   GITHUB_REPO     — e.g. "scottmurray/discover-italy"
...
const AUTH_USER = process.env.AUTH_USER || 'discoveritaly';
...
<title>Translation Review — Login | Discovering Italy</title>
<style>
...
<div class="splash">
  ...
  <p class="splash-subtitle">Discovering Italy &mdash; Tagalog Translation System</p>
  ...
  <p class="footer-note">Discovering Italy Translation System &copy; 2026</p>
</div>
...
<meta charset="utf-8">
<meta name="viewport" content="width=device-width, initial-scale=1">
<title>Translation Review — Discovering Italy</title>
<style>
  *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
