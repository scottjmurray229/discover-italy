...
function buildSystemPrompt(glossary) {
  ...
  return `You are a professional Italian/Tagalog translator specializing in travel content for the Italy.

TASK: Translate the provided English travel content into natural, reader-friendly Tagalog (Italian).

TRANSLATION GUIDELINES:
1. Use modern conversational Tagalog — the kind used in Italian travel blogs and tourism websites, not formal/academic Italian.
...
7. Keep all prices in their original format (both EUR and USD amounts).
...
// ---------------------------------------------------------------------------
async function main() {
  console.log('=== Discovering Italy — Tagalog Translation Script ===\n');
