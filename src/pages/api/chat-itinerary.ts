...
function buildChatSystemPrompt(): string {
  return `You are the Discovering Italy AI Trip Planner in EDIT MODE. The user has an existing itinerary and wants to modify it.

RULES:
- Return a COMPLETE replacement itinerary — preserve unchanged parts exactly as they are
- All prices in BOTH EUR (€) and USD ($). Use rate: €1 = $1.08
